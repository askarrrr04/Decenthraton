...
- **Damage Detection** — выявляет удары, царапины, ржавчину и другие повреждения.  
- **Dirt Detection** — определяет, грязная ли машина.  
- **Parts Localization** — определяет участок детали автомобиля (например, левая дверь) и визуализирует повреждение на 3D-модели.  
